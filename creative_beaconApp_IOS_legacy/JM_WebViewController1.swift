...
class JM_WebViewController1: UIViewController, TamraManagerDelegate {

    @IBOutlet var webView: UIWebView!

    var receiveUrl = "/creativeEconomy/JungmunInfo.do"
    ...
    func isExistsMappingContentsId(_ spotId: Int, spotDesc: String) {
        ...
        if spotId == 37 {
            ...
            print("JM_Beacon_1 : 매핑 컨텐츠 검색 시작")
