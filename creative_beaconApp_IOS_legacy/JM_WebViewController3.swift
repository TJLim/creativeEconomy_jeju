...
class JM_WebViewController3: UIViewController, TamraManagerDelegate {

    @IBOutlet var webView: UIWebView!

    var receiveUrl = "/creativeEconomy/JungmunAttraction.do"
    ...
    func isExistsMappingContentsId(_ spotId: Int, spotDesc: String) {
        ...
        if spotId == 37 {
            ...
            print("JM_Beacon_3 : 매핑 컨텐츠 검색 시작")
