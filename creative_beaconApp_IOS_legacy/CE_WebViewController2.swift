...
class CE_WebViewController2: UIViewController, TamraManagerDelegate {

    @IBOutlet var webView: UIWebView!

    var receiveUrl = "/creativeEconomy/CreativeFacility.do"    //
    ...
    func isExistsMappingContentsId(_ spotId: Int, spotDesc: String) {
        ...
        if spotId == 37 {
            ...
            print("CE_Beacon_2 : 매핑 컨텐츠 검색 시작")
